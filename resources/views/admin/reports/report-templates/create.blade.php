...
@section('content')
    <div class="flex flex-wrap items-center justify-between gap-4">
        <h2 class="text-xl font-semibold uppercase">Create Report Template</h2>
        ...
        <form action="{{ route('admin.reports.report-templates.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div class="form-group md:col-span-2">
                    ...
                    <textarea name="configuration" id="configuration" class="form-input" rows="4">{{ old('configuration') }}</textarea>
                    <p class="mt-1 text-xs text-white-dark">Define query criteria, columns, chart config as JSON.</p>
                </div>
            </div>
