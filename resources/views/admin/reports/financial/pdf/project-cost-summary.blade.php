...
<table class="stats">
    <tr>
        <td><div class="value" style="color:#4361ee">{{ number_format($totals['budget']) }}</div><div class="label">Total Budget</div></td>
        <td><div class="value" style="color:#e2a03f">{{ number_format($totals['actual_cost']) }}</div><div class="label">Actual Cost</div></td>
        <td><div class="value" style="color:#2196f3">{{ number_format($totals['po_total']) }}</div><div class="label">PO Spend</div></td>
        <td><div class="value" style="color:#00ab55">{{ number_format($totals['invoiced']) }}</div><div class="label">Invoiced</div></td>
        <td><div class="value" style="color:#805dca">{{ number_format($totals['paid']) }}</div><div class="label">Paid</div></td>
        <td><div class="value" style="color:#e7515a">{{ number_format($totals['due']) }}</div><div class="label">Due</div></td>
    </tr>
</table>
