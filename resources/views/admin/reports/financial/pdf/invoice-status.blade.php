...
<table class="data">
    <thead>
        <tr><th>Project</th><th class="text-center">Invoices</th><th class="text-center">Total</th><th class="text-center">Paid</th><th class="text-right">Due</th></tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">{{ number_format($bp['total'], 2) }}</td>
            <td class="text-center text-success">{{ number_format($bp['paid'], 2) }}</td>
...
<table class="data">
    <thead>
        <tr><th>Invoice #</th><th>Project</th><th class="text-center">Total</th><th class="text-center">Paid</th><th class="text-center">Due</th><th class="text-center">Retention</th><th>Due Date</th><th class="text-right">Status</th></tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center text-success">{{ number_format($inv->paid_amount, 2) }}</td>
            <td class="text-center text-danger">{{ number_format($inv->due_amount, 2) }}</td>
            <td class="text-center text-warning">{{ number_format($inv->retention_amount, 2) }}</td>
            <td>{{ $inv->due_date->format('d M Y') }}</td>
            <td class="text-right">{{ ucfirst(str_replace('_',' ',$inv->status)) }}</td>
        </tr>
        @empty
