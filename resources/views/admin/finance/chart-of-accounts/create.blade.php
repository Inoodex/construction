...
@section('content')
    <div class="flex flex-wrap items-center justify-between gap-4">
        <h2 class="text-xl font-semibold uppercase">Add Account</h2>
    ...
    <div class="panel mt-6">
        <form action="{{ route('admin.finance.chart-of-accounts.store') }}" method="POST">
            @csrf
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                <div class="form-group">
                    <label for="account_code">Account Code <span class="text-danger">*</span></label>
                    <input type="text" name="account_code" id="account_code" class="form-input" required value="{{ old('account_code') }}" placeholder="e.g. 1-1000" />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-input" required value="{{ old('name') }}" placeholder="e.g. Cash & Bank" />
                ...
                <div class="form-group">
                    ...
                    <span class="text-xs text-white-dark mt-1 block">Auto-set based on type. Change if needed.</span>
            ...
            <div class="mt-8 flex items-center gap-4">
                <button type="submit" class="btn btn-primary px-10">Save Account</button>
