...
@section('title', 'Create Rate Analysis')

@section('content')
    <div class="flex flex-wrap items-center justify-between gap-4">
        <h2 class="text-xl font-semibold uppercase">Create Rate Analysis</h2>
    ...
    <div class="panel mt-6">
        <form action="{{ route('admin.finance.rate-analysis.store') }}" method="POST">
            @csrf
            ...
            <div class="mt-8 flex items-center gap-4">
                <button type="submit" class="btn btn-primary px-10">Create Rate Analysis</button>
