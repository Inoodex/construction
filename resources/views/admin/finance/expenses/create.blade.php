...
@section('content')
    <div class="flex flex-wrap items-center justify-between gap-4">
        <h2 class="text-xl font-semibold uppercase">Create Expense</h2>
        ...
        <form action="{{ route('admin.finance.expenses.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                ...
                <div class="form-group">
                    ...
                    <select name="category_id" id="category_id" class="form-select" required>
                        ...
                        @foreach($categories as $cat)
                            <option value="{{ $cat->id }}" {{ old('category_id') == $cat->id ? 'selected' : '' }}>{{ $cat->label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="expense_date" id="expense_date" class="form-input" required value="{{ old('expense_date', now()->format('Y-m-d')) }}" />
                ...
                <div class="form-group">
                    ...
                    @error('payment_account_id') <span class="text-danger text-sm">{{ $message }}</span> @enderror
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="reference_number" id="reference_number" class="form-input" value="{{ old('reference_number') }}" />
                </div>
                ...
                <div class="form-group md:col-span-3">
                    ...
                    <p class="mt-1 text-xs text-white-dark">Accepted: JPG, PNG, PDF (max 2MB)</p>
                </div>
            </div>

            <div class="mt-8 flex items-center gap-4">
                <button type="submit" class="btn btn-primary px-10">Create Expense</button>
