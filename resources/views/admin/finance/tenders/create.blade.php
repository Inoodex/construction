...
@section('content')
    <div class="flex flex-wrap items-center justify-between gap-4">
        <h2 class="text-xl font-semibold uppercase">Create Tender</h2>
    ...
    <div class="panel mt-6">
        <form action="{{ route('admin.finance.tenders.store') }}" method="POST">
            @csrf
            <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="close_date" id="close_date" class="form-input" required value="{{ old('close_date') }}" />
                </div>
            ...
            <div class="mt-8 flex items-center gap-4">
                <button type="submit" class="btn btn-primary px-10">Create Tender</button>
