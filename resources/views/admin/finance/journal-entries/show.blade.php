...
<div class="panel mt-6">
    <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
        <div><span class="text-xs text-white-dark">Journal #</span>
            <p class="font-mono font-semibold">{{ $entry->journal_number }}</p>
        </div>
        <div><span class="text-xs text-white-dark">Date</span>
            <p>{{ $entry->date->format('d M Y') }}</p>
        </div>
        <div><span class="text-xs text-white-dark">Type</span>
            <p class="capitalize">{{ $entry->type }}</p>
        </div>
        ...
        <div class="md:col-span-4"><span class="text-xs text-white-dark">Description</span>
            <p>{{ $entry->description }}</p>
        </div>
        @endif
        <div class="md:col-span-4"><span class="text-xs text-white-dark">Created By</span>
