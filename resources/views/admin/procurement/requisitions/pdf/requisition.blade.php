...
<head>
    <meta charset="UTF-8">
    <title>Purchase Requisition - {{ $requisition->requisition_number }}</title>
    <style>
        @page { margin: 0; }
    ...
    <div class="wrapper">
        ...
        <div class="content">
            <div style="margin-bottom:15px;">
                <div class="doc-number">{{ $requisition->requisition_number }}</div>
            </div>
            ...
            <table class="meta-table">
                <tr>
                    ...
                    <th>Status</th>
                    <td style="text-transform:capitalize;">{{ $requisition->status }}</td>
                </tr>
                <tr>
                    <th>Requested By</th>
                ...
                <tbody>
                    @forelse($requisition->items as $i => $item)
                        <tr>
                            ...
                            <td>{{ $item->estimated_unit_price ? number_format($item->quantity * $item->estimated_unit_price, 2) : '—' }}</td>
                        </tr>
                    @empty
