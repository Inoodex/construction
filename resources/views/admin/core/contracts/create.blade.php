...
@section('content')
    <div class="flex flex-wrap items-center justify-between gap-4">
        <h2 class="text-xl font-semibold uppercase">New Contract</h2>
    ...
    <form action="{{ route('admin.core.contracts.store') }}" method="POST" class="mt-6">
        @csrf
        <div class="panel grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="client_name" value="{{ old('client_name') }}" class="form-input w-full" required />
            ...
            <div>
                ...
                <select name="contract_type" class="form-select w-full" required>
                    @foreach(['main' => 'Main', 'subcontract' => 'Subcontract', 'supply' => 'Supply', 'consultancy' => 'Consultancy'] as $val => $lbl)
                        <option value="{{ $val }}" {{ old('contract_type', 'main') == $val ? 'selected' : '' }}>{{ $lbl }}</option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input type="number" step="0.01" name="contract_value" value="{{ old('contract_value', '0.00') }}" class="form-input w-full" required />
                @error('contract_value') <span class="text-danger text-xs">{{ $message }}</span> @enderror
            </div>

            <div>
                <label class="block text-sm font-medium mb-1">Currency</label>
                <input type="text" name="currency" value="{{ old('currency', 'BDT') }}" class="form-input w-full" />
            ...
            <div>
                ...
                <input type="date" name="signing_date" value="{{ old('signing_date') }}" class="form-input w-full" required />
            ...
            <div>
                ...
                <input type="date" name="commencement_date" value="{{ old('commencement_date') }}" class="form-input w-full" required />
            ...
            <div>
                ...
                <input type="date" name="extended_completion_date" value="{{ old('extended_completion_date') }}" class="form-input w-full" />
            ...
            <div>
                ...
                <input type="number" step="0.01" name="retention_percentage" value="{{ old('retention_percentage', '5.00') }}" class="form-input w-full" />
            ...
            <div>
                ...
                <input type="number" step="0.01" name="liquidated_damages_rate" value="{{ old('liquidated_damages_rate') }}" class="form-input w-full" />
            ...
            <div>
                ...
                <input type="number" step="0.01" name="advance_payment_percentage" value="{{ old('advance_payment_percentage') }}" class="form-input w-full" />
