...
@section('content')
    <div class="flex flex-wrap items-center justify-between gap-4">
        <h2 class="text-xl font-semibold uppercase">Create Phase — {{ $project->name }}</h2>
    ...
    <div class="panel mt-6">
        <form action="{{ route('admin.core.projects.phases.store', $project) }}" method="POST">
            @csrf
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="order_index" id="order_index" class="form-input" min="0" value="{{ old('order_index', 0) }}" />
                </div>
                <div class="form-group">
            ...
            <div class="mt-8 flex items-center gap-4">
                <button type="submit" class="btn btn-primary px-10">Save Phase</button>
