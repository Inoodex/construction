            ...
            <form method="POST" action="{{ route('tyro-login.login.submit') }}">
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        ...
                        <button type="button" id="toggle-password" style="position: absolute; right: 0.75rem; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; padding: 0; color: #9ca3af; display: flex; align-items: center;" aria-label="Show password">
