...
class ChartOfAccountSeeder extends Seeder
{
    public function run(): void
    {
        $accounts = [
            ...
            ['account_code' => '1-1050', 'name' => 'Retention Receivable', 'type' => 'asset', 'normal_balance' => 'debit', 'parent_code' => '1-1000'],
            ...
            ['account_code' => '2-1030', 'name' => 'Tax Payable', 'type' => 'liability', 'normal_balance' => 'credit', 'parent_code' => '2-1000'],
        ...
        foreach ($accounts as $acc) {
            if ($acc['parent_code'] === null) {
                $created[$acc['account_code']] = ChartOfAccount::firstOrCreate(
        ...
        foreach ($accounts as $acc) {
            if ($acc['parent_code'] !== null) {
                $parent = $created[$acc['parent_code']]
                    ?? ChartOfAccount::where('account_code', $acc['parent_code'])->first();
                if ($parent) {
